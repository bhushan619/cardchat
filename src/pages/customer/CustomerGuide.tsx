...
const guides: GuideSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { text: "Take clear photos of your gift card — front and back — and send them using the image icon next to the send button.", tip: "Make sure the card code/PIN and any barcodes are clearly visible in the photos." },

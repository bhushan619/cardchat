...
const guides: GuideSection[] = [
  {
    ...
    steps: [
      ...
      { text: "Click on any conversation to open the full chat view with a tabbed sidebar (Orders + Sales Order)." },
  ...
  },
  {
    ...
    steps: [
      ...
      { text: "Drag chat images and drop them onto card entries to attach them (used images are dimmed with a checkmark)." },

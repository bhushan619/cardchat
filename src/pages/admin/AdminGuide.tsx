...
import { ChevronDown, ChevronRight, MessageSquare, CreditCard, FileText, DollarSign, Users, BarChart3, Globe, Send, Shield, Search, BookOpen, CheckCircle2, KeyRound, MessagesSquare } from "lucide-react";
...
const guides: GuideSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { text: "The header displays the current system Points Rate and Price Control percentage." },
      ...
      { text: "Rate formulas: Sell Rate = Points Rate × Buy Rate. Buy Rate = Sell Rate × Price Control." },
  ...
  {
    id: "naira-rate",
    title: "Setting the System Points Rate & Price Control",
    icon: DollarSign,
    description: "Update the global NGN/CNY rate and price control used for all order calculations.",
    roles: ["Super Admin", "Team Lead"],
    steps: [
      { text: "Navigate to 'Points Rate' from the sidebar (Super Admin and Team Lead only)." },
  ...
  },
  {
    ...
    roles: ["All Roles"],
    steps: [
      { text: "Super Admin: Full access to all features including Points Rate, User Management, IP & Country Restrictions, Sensitive Words, API Config, SMS Broadcast, and ranking reward distribution." },
      { text: "Team Lead: Access to Messages, Customers, Card Rates, Orders, Points Rate, Volume Ranking, Rewards (view only), and the Team Dashboard." },
      ...
      { text: "Finance: Access to Orders (read-only), Platform Wallet, Points Rate, and Team Chat. No access to Volume Ranking or Rewards." },

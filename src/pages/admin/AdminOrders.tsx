...
const mockOrderDetails: Record<string, OrderDetail> = {
  "ORD-20260318-001": {
    ...
    timeline: [
      ...
      { event: "Cards verified", time: "18/03/2026 · 10:38 AM" },
      { event: "Settled", time: "18/03/2026 · 10:40 AM" },
      { event: "Payment sent", time: "18/03/2026 · 10:42 AM" },
    ],
    creationTime: "18/03/2026 · 10:37 AM",
    cardFaceValue: 200,
    cardCode: "ORD-20260318-001",
    cardNumber: "4539129876543210",
    orderReceivingTime: "18/03/2026 · 10:37 AM",
    orderFaceValue: 200,
    orderUnitPrice: 680,
    orderAmount: 136000,
    nairaRate: 289,
    ...
    cardStatus: "Verified",
    checked: "Yes",
    createTime: "18/03/2026 · 10:37 AM",
  },
  "ORD-20260318-002": {
    cardFormat: "E-Code",
    agent: "Tunde Agent",
    timeline: [
      { event: "Order created", time: "18/03/2026 · 09:15 AM" },
      { event: "Cards submitted", time: "18/03/2026 · 09:20 AM" },
    ],
    creationTime: "18/03/2026 · 09:15 AM",
    cardFaceValue: 150,
    cardCode: "ORD-20260318-002",
    cardNumber: "5412753498761234",
    orderReceivingTime: "18/03/2026 · 09:15 AM",
    orderFaceValue: 150,
    orderUnitPrice: 620,
    orderAmount: 93000,
    nairaRate: 289,
    ...
    cardStatus: "Pending",
    checked: "No",
    createTime: "18/03/2026 · 09:15 AM",
  },
  "ORD-20260318-003": {
    cardFormat: "Physical",
    agent: "Mike Agent",
    timeline: [
      { event: "Order created", time: "18/03/2026 · 08:45 AM" },
      { event: "Cards verified", time: "18/03/2026 · 08:50 AM" },
      { event: "Settled", time: "18/03/2026 · 09:00 AM" },
    ],
    creationTime: "18/03/2026 · 08:45 AM",
    cardFaceValue: 200,
    cardCode: "ORD-20260318-003",
    cardNumber: "3782822463100051",
    orderReceivingTime: "18/03/2026 · 08:45 AM",
    orderFaceValue: 200,
    orderUnitPrice: 600,
    orderAmount: 120000,
    nairaRate: 289,
    ...
    cardStatus: "Invalid",
    checked: "No",
    createTime: "18/03/2026 · 08:45 AM",
  },
};
            ...
            {filtered.length > 0 && (
              <tfoot>
                <tr className="border-t bg-muted/50 font-semibold">
                  <td className="px-2" />
                  <td className="px-4 py-3 text-xs" colSpan={8}>

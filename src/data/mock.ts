...
const baseRates: Array<{
...
}> = [
  {
    ...
    cardFormat: "Physical",
    sellRate: 720,
    denominationSpec: { kind: "list", values: [10, 25, 50, 100, 200, 500] },
  ...
  },
  {
    ...
    cardFormat: "E-Code",
    sellRate: 740,
    denominationSpec: { kind: "range", min: 10, max: 500 },
    lastUpdated: "2 min ago",
  },
  {
    cardType: "Amazon US",
    ...
    cardFormat: "Physical",
    sellRate: 660,
    denominationSpec: { kind: "list", values: [25, 50, 100, 200, 500, 1000] },
    lastUpdated: "2 min ago",
  },
  {
    cardType: "Amazon US",
    ...
    cardFormat: "E-Code",
    sellRate: 680,
    denominationSpec: { kind: "multiples", of: 5, min: 10, max: 500 },
    lastUpdated: "2 min ago",
  },
  {
    cardType: "Steam US",
    ...
    cardFormat: "Physical",
    sellRate: 640,
    denominationSpec: { kind: "list", values: [20, 50, 100] },
  ...
  },
  {
    ...
    cardFormat: "E-Code",
    sellRate: 660,
    denominationSpec: { kind: "multiples", of: 10 },
    lastUpdated: "3 min ago",
  },
  {
    cardType: "Google Play US",
    currency: "USD",
    cardFormat: "Physical",
    sellRate: 630,
    denominationSpec: { kind: "list", values: [10, 25, 50, 100] },
    lastUpdated: "2 min ago",
  },
  {
    cardType: "iTunes UK",
    ...
    cardFormat: "Physical",
    sellRate: 900,
    denominationSpec: { kind: "range", min: 10, max: 200 },
  ...
  },
  {
    ...
    cardFormat: "Physical",
    sellRate: 830,
    denominationSpec: { kind: "list", values: [25, 50, 100, 200] },
    lastUpdated: "3 min ago",
  },
  {
  ...
  },
  {
    ...
    cardFormat: "E-Code",
    sellRate: 700,
    denominationSpec: { kind: "multiples", of: 5, min: 10, max: 200 },
    lastUpdated: "1 min ago",
  },
  {
    cardType: "Sephora",
    ...
    cardFormat: "Physical",
    sellRate: 520,
    denominationSpec: { kind: "list", values: [25, 50, 100, 200, 500] },
  ...
  },
  {
    ...
    cardFormat: "Physical",
    sellRate: 560,
    denominationSpec: { kind: "range", min: 25, max: 500 },
    lastUpdated: "4 min ago",
  },
  {
    cardType: "Nordstrom",
...
export function formatDenominations(spec: DenominationSpec, symbol = "$"): string {
  ...
  if (spec.kind === "multiples") {
    const bounds =
      spec.min || spec.max ? ` (${symbol}${spec.min ?? spec.of}${spec.max ? `–${symbol}${spec.max}` : "+"})` : "";
...
export const systemPriceControl = 85.0; // normal price control, percentage 1.00% - 100.00%
export const systemVipPriceControl = 88.0; // VIP price control, percentage 1.00% - 100.00%
...
export const conversations = [
  {
    ...
    waNickname: "Amara ✨",
    alias: "A7X3KP",
    lastMessage: "I have iTunes $100 cards to sell",
    time: "2m",
    unread: 2,
    ...
    totalValue: "₦450,000",
    tags: ["VIP", "Repeat"],
    channel: "trtc" as MessagingChannel,
    whatsappNumber: "+234 803 111 2222",
  },
  {
    id: "c2",
    alias2: "T7C2XB",
    waNickname: "Tobi Bello",
    alias: "K9M2BL",
    lastMessage: "Card images sent",
    time: "5m",
    unread: 0,
    ...
    whatsappNumber: "+234 805 444 7788",
  },
  {
    id: "c3",
    alias2: "S1G6JD",
    waNickname: "Segun Cards",
    alias: "R4P8TN",
    lastMessage: "When will I receive payment?",
    time: "8m",
    unread: 1,
    status: "trading" as const,
    goodRate: 90,
    ...
    tags: ["VIP"],
    channel: "trtc" as MessagingChannel,
    whatsappNumber: "+234 809 222 3344",
  },
  {
    id: "c4",
    alias2: "N8K3RY",
    waNickname: "Mama Nkechi",
    alias: "B5N1QW",
    ...
    tags: [],
    channel: "whatsapp" as MessagingChannel,
    whatsappNumber: "+234 812 998 5566",
  },
  {
    id: "c5",
    alias2: "F5W1HP",
    waNickname: "Ifeanyi Cards",
    alias: "H2L6YD",
    lastMessage: "Sending Amazon $50 card now",
    time: "20m",
    unread: 0,
    status: "trading" as const,
    goodRate: 78,
    ...
    tags: ["Repeat"],
    channel: "trtc" as MessagingChannel,
    whatsappNumber: "+234 807 661 2233",
  },
  {
    id: "c6",
    alias2: "E2Z7LM",
    waNickname: "Emeka Ent.",
    alias: "W8T4FJ",
    lastMessage: "Please check my bank details",
    time: "25m",
    unread: 3,
    status: "consulting" as const,
    goodRate: 88,
    ...
    tags: ["VIP", "Priority"],
    channel: "whatsapp" as MessagingChannel,
    whatsappNumber: "+234 814 770 9911",
  },
  {
    id: "c7",
    alias2: "D9Q4VT",
    waNickname: "Dayo T.",
    alias: "D3F9RX",
    lastMessage: "I want to sell Steam cards",
    time: "30m",
    unread: 0,
    status: "consulting" as const,
    goodRate: 60,
...
export const chatMessages = [
  { id: 1, sender: "customer", text: "Hi, I have 2x iTunes $100 cards to sell", time: "10:32 AM" },
  {
    id: 2,
    sender: "agent",
    text: "Hello! Sure, please send clear images of both cards (front and back)",
    time: "10:33 AM",
  },
  ...
  { id: 4, sender: "agent", text: "Cards received. Let me verify them now.", time: "10:36 AM" },
  {
    id: 5,
    sender: "system",
    text: "Order #ORD-20260318-001 created. Card: iTunes US $100 ×2.",
    time: "10:37 AM",
    isOrder: true,
  },
...
export const orders = [
  {
    ...
    source: "in-app" as OrderSource,
    transferStatus: "successful" as OrderTransferStatus,
    created: "18/03/2026 · 10:37 AM",
  },
  {
    id: "ORD-20260318-002",
    customer: "K9M2BL",
    ...
    transferStatus: "pending" as OrderTransferStatus,
    created: "18/03/2026 · 09:15 AM",
  },
  {
    id: "ORD-20260318-003",
    customer: "R4P8TN",
    ...
    nairaRate: 289,
    unitPrice: 600,
    status: "order_cancelled" as const,
    source: "in-app" as OrderSource,
    transferStatus: "not_transferred" as OrderTransferStatus,
    created: "18/03/2026 · 08:45 AM",
  },
];
...
export const adminUsers = [
  {
    id: 1,
    name: "Admin One",
    email: "admin@cardchat.com",
    role: "super_admin" as const,
    status: "active" as const,
    lastLogin: "2 min ago",
    macAddress: "f7-c4-f0-e2-23-cd",
  },
  {
    id: 2,
    name: "Sarah Lead",
    email: "sarah@cardchat.com",
    role: "team_lead" as const,
    status: "active" as const,
    lastLogin: "10 min ago",
    macAddress: "b2-18-7f-c3-9d-04",
  },
  {
    id: 3,
    name: "Mike Agent",
    email: "mike@cardchat.com",
    role: "agent" as const,
    status: "active" as const,
    lastLogin: "5 min ago",
    macAddress: "cc-4a-92-11-e7-55",
  },
  {
    id: 4,
    name: "Tunde Agent",
    email: "tunde@cardchat.com",
    role: "agent" as const,
    status: "active" as const,
    lastLogin: "1 hr ago",
    macAddress: "d0-9b-33-67-af-8e",
  },
  {
    id: 5,
    name: "Joy Agent",
    email: "joy@cardchat.com",
    role: "agent" as const,
    status: "offline" as const,
    lastLogin: "3 hrs ago",
    macAddress: "e8-71-2c-44-bd-19",
  },
  {
    id: 6,
    name: "Femi Finance",
    email: "femi@cardchat.com",
    role: "finance" as const,
    status: "active" as const,
    lastLogin: "15 min ago",
    macAddress: "f3-66-a1-dd-05-70",
  },
];

export const nairaRateHistory = [
  {
    timestamp: "18/03/2026 · 10:00 AM",
    oldRate: 270,
    newRate: 289,
    oldPriceControl: 84.0,
    newPriceControl: 85.0,
    oldVipPriceControl: 87.0,
    newVipPriceControl: 88.0,
    changedBy: "Admin One",
    reason: "Market adjustment",
  },
  {
    timestamp: "17/03/2026 · 02:30 PM",
    oldRate: 255,
    newRate: 270,
    oldPriceControl: 84.0,
    newPriceControl: 84.0,
    oldVipPriceControl: 86.5,
    newVipPriceControl: 87.0,
    changedBy: "Admin One",
    reason: "Daily update",
  },
  {
    timestamp: "16/03/2026 · 09:00 AM",
    oldRate: 240,
    newRate: 255,
    oldPriceControl: 83.5,
    newPriceControl: 84.0,
    oldVipPriceControl: 86.5,
    newVipPriceControl: 86.5,
    changedBy: "Admin One",
...
export const walletTransactions = [
  {
    ...
    amount: 215200,
    description: "Order #ORD-20260318-001 — iTunes US",
    date: "18/03/2026",
    time: "10:42 AM",
  },
  {
    ...
    amount: 150000,
    description: "Withdrawal to First Bank ****1234",
    date: "18/03/2026",
    time: "11:15 AM",
  },
  {
    ...
    type: "credit" as const,
    amount: 93000,
    description: "Order #ORD-20260317-005 — Amazon US",
    date: "17/03/2026",
    time: "03:20 PM",
  },
  {
    ...
    type: "withdrawal" as const,
    amount: 80000,
    description: "Withdrawal to GTBank ****5678",
    date: "17/03/2026",
    time: "04:00 PM",
  },
  {
    ...
    type: "credit" as const,
    amount: 62000,
    description: "Order #ORD-20260315-008 — iTunes UK",
    date: "15/03/2026",
    time: "02:10 PM",
  },
  {
    ...
    type: "credit" as const,
    amount: 186000,
    description: "Order #ORD-20260316-003 — Steam US",
    date: "16/03/2026",
    time: "09:30 AM",
  },
  {
    ...
    type: "withdrawal" as const,
    amount: 50000,
    description: "Withdrawal to Access Bank ****9012",
    date: "15/03/2026",
    time: "05:45 PM",
  },
];
...
export const groupMessages: Record<string, GroupMessage[]> = {
  g1: [
    {
      ...
      sender: "participant",
      participantId: "g1p1",
      text: "Good morning all 👋 Rates for iTunes today?",
      time: "09:02 AM",
    },
    ...
    { id: 4, sender: "participant", participantId: "g1p4", text: "I have 3x $100 Amazon to move.", time: "09:08 AM" },
    {
      id: 5,
      sender: "agent",
      text: "Steam e-code is 660. Amara, please DM me for the Amazon batch.",
      time: "09:10 AM",
    },
    {
      id: 6,
      sender: "participant",
      participantId: "g1p7",
      text: "Is the rate fixed for the whole day?",
      time: "09:14 AM",
    },
    {
      id: 7,
      sender: "participant",
      participantId: "g1p6",
      text: "Rates were solid yesterday, paid within 5 mins 🙏",
      time: "09:18 AM",
    },
  ...
  g2: [
    ...
    { id: 2, sender: "agent", text: "Yes, Razer Gold e-code at 700.", time: "08:33 AM" },
    {
      ...
      sender: "participant",
      participantId: "g2p3",
      text: "Noted. I'll send mine after lunch.",
      time: "08:40 AM",
    },
  ...
  g3: [
    { id: 1, sender: "participant", participantId: "g3p3", text: "Group is quiet today 😅", time: "07:45 AM" },
    {
      ...
      sender: "participant",
      participantId: "g3p2",
      text: "I just cashed out, smooth as usual.",
      time: "07:50 AM",
    },
...
groupMessages.g5 = [
  { id: 1, sender: "participant", participantId: "g5p1", text: "Amazon $50 x3 available", time: "09:20 AM" },
  {
    ...
    sender: "participant",
    participantId: "g5p2",
    text: "Please pay my Opay account when done 🙏",
    time: "09:24 AM",
  },
